...
Inside `backend/documents/` you'll find a small case file: a Motion for Summary Judgment in a personal injury lawsuit (_Rivera v. Harmon Construction Group_), along with a police report, medical records, and a witness statement.
